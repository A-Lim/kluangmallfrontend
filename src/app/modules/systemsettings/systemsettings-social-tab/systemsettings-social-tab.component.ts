...
@Component({
  selector: 'systemsettings-social-tab',
  templateUrl: './systemsettings-social-tab.component.html',
  styleUrls: ['./systemsettings-social-tab.component.css']
})
export class SystemSettingsSocialTabComponent extends Base implements OnInit, OnDestroy, AfterViewInit {
  @ViewChild('form')
  form: NgForm;
